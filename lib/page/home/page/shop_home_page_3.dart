...
import '../widget/shop_secondary_tabView.dart';
import 'shop_home_product_list_page.dart';
import 'shop_home_product_list_page_1.dart';

class ShopHomePage3 extends StatefulWidget {
  const ShopHomePage3({Key? key}) : super(key: key);

  @override
  State<ShopHomePage3> createState() => _ShopHomePage3State();
}

class _ShopHomePage3State extends State<ShopHomePage3>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetBuilder<ShopHomeController>(
        builder: (controller) {
